...
function sendInputToGAS3(message, isUserMessage) {
    const GAS_URL3 = 'https://script.google.com/macros/s/AKfycbxvpQ6Fsnf5QLnXUrK-KYbq9ZPeX0jovtYnaKogA8THSL6NvSj7b7OlZOL0lW6CNL5vVA/exec'; // Replace with your actual URL
...
function startConversation() {
    fetch('https://chatbot-for-dana-point-montessori-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-dana-point-montessori-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGAS(message, isUserMessage) {
    var GAS_URL = 'https://script.google.com/macros/s/AKfycbw59Ra8-2TjAE-NbZfNaN0gRzDM6bSaTDo0fTI6abrY0GYElqBh0CuUAaxW-hzUR43FyA/exec';
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbw7Hg6OTlsAlLU9zo-PnQ9vXYvcMdGCGg4zIryWResVOUNqcQQ3iCl5xLoIGSsY26gz/exec';
